...
class DisplayStripeUrlMobile extends StatefulWidget {
  final String checkOutUrl;
  const DisplayStripeUrlMobile({super.key, required this.checkOutUrl});

  @override
  State<DisplayStripeUrlMobile> createState() => _DisplayStripeUrlMobileState();
}
