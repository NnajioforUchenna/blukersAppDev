...
class SetJobsPreferences extends StatefulWidget {
  const SetJobsPreferences({super.key});

  @override
  State<SetJobsPreferences> createState() => _SetJobsPreferencesState();
}

class _SetJobsPreferencesState extends State<SetJobsPreferences> {
