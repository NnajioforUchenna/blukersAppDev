...
class SetJobsPreferencesDesktop extends StatefulWidget {
  const SetJobsPreferencesDesktop({super.key});

  @override
  State<SetJobsPreferencesDesktop> createState() =>
      _SetJobsPreferencesDesktopState();
}

class _SetJobsPreferencesDesktopState extends State<SetJobsPreferencesDesktop> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.setJobPreferences,
