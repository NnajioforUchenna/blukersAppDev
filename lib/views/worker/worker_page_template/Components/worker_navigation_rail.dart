...
class WorkerNavigationRail extends StatefulWidget {
  const WorkerNavigationRail({super.key});

  @override
  State<WorkerNavigationRail> createState() => _WorkerNavigationRailState();
}

class _WorkerNavigationRailState extends State<WorkerNavigationRail> {
