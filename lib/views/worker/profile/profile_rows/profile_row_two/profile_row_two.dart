import 'package:blukers/views/worker/profile/profile_rows/profile_row_two/select_input_profile_image.dart';
...
class ProfileRowTwo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        showDialog(
            context: context, builder: (context) => SelectInputProfileImage());
      },
      child: Stack(
        children: [
          Container(
