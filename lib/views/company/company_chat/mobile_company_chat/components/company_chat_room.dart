...
class CompanyChatRoom extends StatefulWidget {
  const CompanyChatRoom({super.key});

  @override
  State<CompanyChatRoom> createState() => _CompanyChatRoomState();
}

class _CompanyChatRoomState extends State<CompanyChatRoom> {
  String textMessage = "";
