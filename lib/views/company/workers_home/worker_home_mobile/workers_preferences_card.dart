...
import 'package:blukers/views/worker/jobs_home/Components/display_jobs_by_preferences/Components/Jobs_preferences_card/Mobile_job_card/Components/filters_section_mobile.dart';
...
class WorkersPreferencesCard extends StatefulWidget {
  const WorkersPreferencesCard({super.key});

  @override
  State<WorkersPreferencesCard> createState() => _WorkersPreferencesCardState();
}

class _WorkersPreferencesCardState extends State<WorkersPreferencesCard> {
