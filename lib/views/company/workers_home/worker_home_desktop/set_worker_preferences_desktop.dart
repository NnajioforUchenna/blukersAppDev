...
class DesktopSetWorkersPreferences extends StatefulWidget {
  const DesktopSetWorkersPreferences({super.key});

  @override
  State<DesktopSetWorkersPreferences> createState() =>
      _DesktopSetWorkersPreferencesState();
}

class _DesktopSetWorkersPreferencesState
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (areJobsSelected()) {
                        up.setWorkersPreferences(
                            selectedIndustries, selectedJobs);
                        wp.getWorkersByPreferences();
                        context.go('/showWorkersByPreferencesDesktop');
                      } else {
