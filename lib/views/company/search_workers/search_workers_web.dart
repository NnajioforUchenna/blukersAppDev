...
class SearchWorkersUiWeb extends StatefulWidget {
  const SearchWorkersUiWeb({super.key});

  @override
  State<SearchWorkersUiWeb> createState() => _SearchWorkersUiWebState();
}

class _SearchWorkersUiWebState extends State<SearchWorkersUiWeb> {
