...
import 'package:blukers/views/worker/worker_home/worker_home_components/jobs_mobile_view/jobs_mobile_view_compnents/job_mobile_choose_target_language.dart';
      ...
      child: Row(
        children: [
          Showcase(
              ...
              child: const CompanyMobileSearchBar()),
          Showcase(
              key: asp.translation,
              description:
