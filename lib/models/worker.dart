...
class Worker {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (jobsPreference != null) 'jobsPreference': jobsPreference?.toMap()
    };
  }
  ...
  static Worker? fromMap(Map<String, dynamic> map) {
    try {
      return Worker(
          ...
          workerBadgeIds:
              (map['workerBadgeIds'] as List?)?.cast<String>() ?? [],
          certificationsIds:
          ...
          modifiedAt: map['modifiedAt'] != null ? int.parse(map['modifiedAt'].toString()) : 0,
          jobsPreference: map['jobsPreference'] != null ? Preference.fromMap(map['jobsPreference']) : null);
    } catch (e) {
